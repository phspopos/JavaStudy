...
Exception 클래스는 모든 예외 처리할 수 있으므로 반드시 마지막
블럭에 사용해야 한다.
클래스의 상속구조느 ctrl+t 로 확인할 수 있다.  
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			for( int i = 0; i < array.length; i++ ) {
				System.out.print("array["+i+"]에 저장할 숫자를 입력 : ");
			...
			/*
			  1번 인덱스에 0을 입력하면 연산이 불가능하므로 예외가 발생
			  된다.
			 */			
			System.out.println("배열에 저장된 두 숫자나주기 : " + array[0]/array[1]);
			...
			System.out.println("숫자로만 입려해야 합니다.");
