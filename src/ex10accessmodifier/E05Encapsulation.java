...
/*
 캡슐화(Encapsulation)
 : 여러가지 업무 조직을 하나로 묶는다는 의미와, 업무의 순서까지 고려한
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		System.out.println("=======================");
		//아래의 메서드 호출을 통해 업무를 순서에 맞게 진행할 수 있다.
