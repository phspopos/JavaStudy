...
/*
 ...
 사용할 수 있다. private은 class정의에는 사용할수 없다.  
 */
...
private class PrivateClass1{
	...
	void myFunc() {
		System.out.println("class 선언 자체가 안되므로 에러");
	}
}
*/

/*
 해당 클래스의 접근지정자는 생략혔으므로 default 클래스로 정의된다.
...
/*
 ...
 또한 public 클래스는 자바파일당 단 하나만 정의 할 수 있다.
 public 으로 정의하는 경우 다른 패키지에서도 접근을 허용하게 되므로
...
public class E01AccessModifier1 {
	...
	private void privateMethod() {
		/*
		 동일 클래스 내에서는 private 멥버라 할지라도 접근을
