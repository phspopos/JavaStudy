...
class MyClass {
	...
	//인스턴스가 가진 데이터를 String으로 반환해 준다.
	@Override
	public String toString() {
		
		//정수를 String으로 변경해서 반환한다.
		return " data = " + String.valueOf(data); //String.valueOf(data) String.valueOf(100);
		//이런 방법도 있다.
		//return ""+data;
	}
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		MyClass mc1 = new MyClass(30);
		MyClass mc2 = new MyClass(30);
