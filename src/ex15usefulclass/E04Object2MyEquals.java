...
/*
  equals()메서드
  - 자바에서 인스턴스의 내용 비교를 위해 비교 연사자(==)를 사용하는것은
...
class IntNumber {
	...
	/*
	  ...
	  위한 코드를 기술함	  
	 */
	//비교를 위해 IntNumber타입의 인스턴스를 매개 변수로 받은 후
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		/*
		  String 과 같은 기본클래스는 별도의 오버라이딩 업이도 내용
		  비교가 가능하다.
		 */
		...
		/*
		  인스턴스간의 비교를 할때는 단순히 참조변수에 대한 비교를 하며
		  안되고, 실제 내용에 대한 비교를 해야한다. 즉 멤버변수끼리
		  비교해서 판단해야 한다.
		 */
		if( num1.myEquals(num3) ) {
			System.out.println("num1과 num3은 동일한 정수"); //결과
		}else {
