...
public class E05Date {
	...
	public static String myDateFormat( Calendar c, String formatStr ) {
		...
		/*
		  서버의 표준시인 1970-01-01 부터 현재까지 시간을 초 단위로
		  반환해주는 메서드 이를 '타임스템프'라고 한다.
		 */
		Date date = c.getTime();
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  동일하믄로 구분을 위해 월을 대문자, 분은 소문자를 사용한다.
		 */
		...
		/*
		  ...
		  사용한다. 두번째 인수가 - 음수이면 과거의 날짜를 구할 수 있다.
		 */
		calendar.add( Calendar.DATE, 3 );	//calendar.add( Calendar.DATE, -3 ); 3일전으로 
		...
		/*
		  올해 크리스마스 까지 남은 날짜를 계산. 여기서는 두가지 서식
