...
public class E04Object1toString {
	...
	public static void main(String[] args) {
		...
		MyFriends fn1 = new MyFriends("성유겸");
		YourFriends fn2 = new YourFriends("헬로비너스");
...
class MyTest2 {
	...
	public MyTest2(int a, String b, boolean c) {
		super();
		this.a = a;
		this.b = b;
		this.c = c;
...
class MyTest {
	...
	public MyTest(int a, String b, boolean c) {
		super();
		this.a = a;
		this.b = b;
		this.c = c;
	...
	//멤버변수 정의 후 자동생성 메뉴를 통해 toString메서드 정의하기
	@Override
	public String toString() {
