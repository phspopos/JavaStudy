...
public class SQLselect1 extends MyConnection {
	...
	/*
	  ...
	  executeQuery()
	  	...
	  	ResutSet 인스턴스가 반환된다. Java에서 반환받은 후
	  	while()문으로 갯수만큼 반복하여 인출한다.
	 */
		...
		try {
			...
			while( rs.next() ) {
				...
				/*
				 ...
				 출력된다. 0000-00-00 00:00:00 형식으므로 적당한 
				...
				/*
				 오라클의 반환함수를 통해 포매팅한 후 문자형식으로 출력한다.
				 쿼리문에 별칭을 사용할 경우 getString()에서 그대로 사용할
				 수 있다. 
				 */
