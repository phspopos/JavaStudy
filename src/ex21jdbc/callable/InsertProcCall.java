...
/*
 Java에서 프로시저 호출하기
  ...
  프로시저 실행을 위한 CallableStatement 인스턴스 생성
  -프로시저 호출시에는 { call 프로시저명( ?,? ... N)}
  -파라미터는 in, out 순서업이 작성할 수 있다. 즉 프로시저 정의에
  따라 달라진다.
 */
public class InsertProcCall extends MyConnection {

	public InsertProcCall(String user, String pass) {
		super(user, pass);		
	...
	public void dbExecute() {
		...
		try {
			/*
			 프로시저는 return값이 없으므로 함수처럼 ?로 시작하지 않는
	...
	public static void main(String[] args) {
		new InsertProcCall("education","1234").dbExecute();
	}
