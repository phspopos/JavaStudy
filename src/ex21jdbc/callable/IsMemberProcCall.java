...
public class IsMemberProcCall extends MyConnection{
	...
	public IsMemberProcCall(String user, String pass) {
		super(user, pass);
		...
		try {
			...
			switch( outParamResult ) {
				case 0:
					...
					break;
				case 1:
					System.out.println("패스워드가 일치하지 않아요 비번찾기 하삼");
					break;
				case 2:
	...
	public static void main(String[] args) {
		new IsMemberProcCall( "education","1234" ).dbExecute();
	}
