	...
	public static void main(String[] args) {
		...
		try {
			...
			if( con != null ) {
				...
				/*
				  1 퀄리문작성 : 작성시 줄바꿈 할때 앞뒤로 스페이스를 하나씩 삽입
				  하는 것이 좋다. 그렇지 않으면 문장이 서로 이어지게 되어
				...
				/*
				  2. 퀄리문 전송을 위해 statement 인터페이스의 인스턴스를 생성한다.
				...
				while( rs.next() ) {
					/*
					 ...
					 형태를 가지고 있다. 컬럼에 접근시에는 인덱스와 컬럼명 두가지
					 모두 사용할 수 있다.
					 */
