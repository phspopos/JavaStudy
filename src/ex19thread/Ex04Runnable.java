...
class Sum {
	...
	/*
	  ...
	  만약 1~10까지 순차적으로 전달된다면 수열의 합 된다.
	 */
...
상속해아 한다면 Runnable인터페이스를 구현해서 쓰레드 클래스를 
정의 해야한다.
 */
...
public class Ex04Runnable {
	...
	public static void main(String[] args) {
		...
		//System.out.println( "11 "+at1.getNum() );
