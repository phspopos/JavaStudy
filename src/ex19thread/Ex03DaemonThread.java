...
: 하나의 클래스가 작업을 완료하야 다음 클래스의 작업을 진행 할 수 있다.
즉 동시에 작업을 진행할 수 없다.
 */
class NormalClass {
...
class NormalThread extends Thread {
	...
	/*
	  ...
	  이름을 저장할 수 있다. 여기서 지정된 이름은 getName()을 통해
	  확인할 수 있다.
	 */
	...
	/*
	  ...
	  직접 처리하지 않고, throws해서 호출한 위치로 예외던지기를 하고 
	  있다.
	 */
...
/*
 ...
 종료될때까지는 프로그램이 종료되는 것은 아니다.
 주로 프로그램의 보조역할로 배경음악재생, 자동저장등의 업무를 처리한
 다. 프로그램이 종료될때 함께 종료되므로 무한루프로 구현한다. 
 */
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  않으므로 5로 지정도니다. 쓰레드 인스턴스 생성시 이름을 부여하
		  는 방법으로 아래 2가지가 잇다.
		 */
		
		//방법 1 : 생성자를 통해 쓰레드의 이름 부여		
		NormalThread yt1 = new NormalThread("1st 쓰레드");
		//방법 2 : setName()을 통해 이름 부여
		//yt1.setName("First 쓰레드");
		yt1.start();
		
		/*
		 두번째 독립쓰레드 생성 및 시작. 쓰레드명을 부여하지 않아씀므로
		 JVM이 자동으로 이름을 부여한다.
		 */
