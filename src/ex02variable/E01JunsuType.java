...
public class E01JunsuType {
	...
	/*
	 ...
	 -일바적으로 cup(중앙처리장치)는 정수형 연산을 가장 빠르게
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 -하지만 큰 자료형화 작은 자료형을 연산하면 큰 자료형으로
		 자동 형변환된다. 이유는 데이터의 손실(오차)이 있을수 있기 때문이다.
		 -단, byte와 short는 예외적인 상황으로 생각하면 된다. cup가 
		 int형의 연산에 최적화 되어 있기 때문이다.
 		 */
