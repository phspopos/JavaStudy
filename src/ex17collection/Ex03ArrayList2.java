	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		  ...
		  갯수를 반환받을수 있다. 인덱스로 접근해야 하므로  get()
		  메서드를 사용한다.
		 */
		...
		/*
		  ...
		  반환할 원소가 있는지 확인후  true이면 next()로 인출한다.
		 */
		...
		for( Student st : list2 ) {
			/*
			  ...
			  므로 getter를 통해 접근해야 한다. 삭제를 위해 입력한 
		...
		for( int i = 0; i < list2.size(); i++ ) {
			String a = ((Student)list2.get(i)).getName();
			System.out.println(a);
			if( removeName.equals(a) ){
		...
		*/
		...
		//System.out.println( list2.remove(st5).getName() );
