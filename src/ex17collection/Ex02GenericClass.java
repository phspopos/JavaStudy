...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  코드가 된다.	
		 */
		//orageBox.store("나는 오렌지");
		//orageBox.store(apple);
		//orageBox.store(banana);
		
		/*
		FruitBox3<Apple> apple5 = new FruitBox3<Apple>( new Apple(20) );
		FruitBox3<Apple> apple6 = new FruitBox3<Apple>();
		apple6.store( new Apple(30) );
		apple6.
		*/
