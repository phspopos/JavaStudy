...
public class Ex07AsList {
	...
	public static void listPrint( String title, List<String> list ) {
		...
		/*
		  출력할 인스턴스가 String 이므로 별도의 오버라이딩 없이도
		  내용을 출력할 수 있다. 만약 우리가 직접 정의한 클래스라면
		  toString을 오버라이딩 행야한다.
		 */
		for( Object ob : list ) {
	...
	public static void main(String[] args) {
		/*
		  String 타입의 배열을 생성과 동시에 초기화. 이경우 초기
		...
		/*
		  ...
		  for( 초기값; 조건식; 증감식 )과 같이 작성해야 하지만
		  next()가 증감식을 대처할 수 있으므로 아래와 같이 작성할 
		  수 있다. (잘 쓰이지는 않음)
		 */
